<?php
    ...
    $arrayPostAll = $_POST['CodforFornecedor'];
    $arrayPost = explode(" - ",$arrayPostAll);
    $codFor = $arrayPost[0]; 
    $fornecedor = $arrayPost[1];


    $query = mysqli_query($conn, "SELECT * FROM desempenho where codFor = '$codFor' ORDER BY mes");
    ...
    <body class="bg-light">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="alert alert-primary alert-sm" role="alert">Você está visualizando o Fornecedor: <?php echo $arrayPostAll; ?>.</div>
                </div>
            </div>
            <table style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th scope="col" style="background-color: #98FB98"><span>Mês</span></th>
                        <th scope="col" style="background-color: #98FB98"><span>Ano</span></th>
                ...
                <tbody>
                    <?php while ($rows = mysqli_fetch_assoc($query)) { ?>
                        <tr>
                            ...
                            <?php echo '<td>'; echo $rows['mes']; echo '</td>';?>
                            <?php echo '<td>'; echo $rows['ano']; echo '</td>';?>
